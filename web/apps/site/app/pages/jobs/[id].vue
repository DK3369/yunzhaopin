...
const api = useApi()
const { data } = await useAsyncData(`job-${id}`, () => api.get('/v1/wap/jobs/detail', { id }))
const job = computed(() => (data.value || {}) as Record<string, unknown>)
const applyMsg = ref('')
