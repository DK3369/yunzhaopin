<template>
    <div class="setUpload">
        <div class="uploadTable">
            ...
            <div class="playbillHeader">
                <div class="playbillHeaText">
                    <span class="span1">{{ lc('admin_01065') }}</span>
                    <span>{{ lc('admin_01084') }}</span>
                </div>
            </div>
            <div class="playbilCont">
                <div class="playbilName">
                    <span>{{ lc('admin_01085') }}</span>
                </div>
                    ...
                    <ul>
                        <li v-for="(item, index) in list" :key="index">
                            ...
                            <div class="playbilAnNiu">
                                <el-button size="small" @click="openAdd(item)">{{ lc('wap_com_00304') }}</el-button>
                                <el-button size="small" @click="del(index)">{{ lc('common.delete') }}</el-button>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_01086')" width="500px" v-model="dialogAdd" :modal-append-to-body="false">
                ...
                <template #footer><div class="dialog-footer">
                    <el-button type="primary" @click="saveWhb">{{ lc('common.submit') }}</el-button>
                </div></template>
            </el-dialog>
        </div>
    </div>
