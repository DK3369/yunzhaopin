    ...
    <div class="moduleElHight" style="margin-left:10px;">
        ...
        <div class="modulePaging">
            <div>
                ...
                <el-button @click="directs(1)" size="small">{{ lc('admin_user_company_00376') }}</el-button>
                <el-button  @click="directs(2)" size="small">{{ lc('admin_user_company_00375') }}</el-button>
            </div>
        ...
        <div class="tck_setbox">
            <el-dialog :title="cztype + lc('admin_company_00042')" v-model="showprogress" :with-header="true" append-to-body
