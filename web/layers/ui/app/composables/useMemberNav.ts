...
export function useMemberNav() {
  ...
  const comMain = computed<MemberNavLink[]>(() => {
    const all: MemberNavLink[] = [
      ...
      { to: '/com/talent-search', label: t('member_com_00597'), icon: 'com_left_icon3' },
    ...
    const groups: MemberMoreGroup[] = [
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/com/tongji', label: t('admin_tool_00181') },
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/com/services', label: t('wap_com_00064') },
          { to: '/com/integral', label: t('wap_user_00008') },
          { to: '/com/integral-rules', label: t('wap_01016') },
          { to: '/com/rewards', label: t('wap_user_00170') },
