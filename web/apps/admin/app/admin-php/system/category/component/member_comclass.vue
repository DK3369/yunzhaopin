<template>
    ...
    <div class="fl_cont">
        ...
        <el-dialog :title="lc('admin_system_00099')" width="580px" v-model="addVisible" :modal-append-to-body="false">
...
<script>
import ComclassAdd from './comclass_add.vue'
import ComclassManage from './comclass_manage.vue'
...
export default {
    ...
    components: {
        'comclass_add': ComclassAdd,
        'comclass_manage': ComclassManage,
    }
};
</script>
<style scoped>
