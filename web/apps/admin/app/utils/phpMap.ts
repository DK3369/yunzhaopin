...
export const PHP_ADMIN_MAP: Record<string, PhpAction> = {
  ...
  'tool/dataCall/getPreviewData': { path: '/v1/admin/data-call/list', transformReq: pageQuery },
  ...
  'tool/dataCollection/getRating': phpPage('dataCollection_getCache'),
  'tool/dataCollection/setLocoyConfig': { path: '/v1/admin/site-settings/batch', transformReq: wrapItems },
  'tool/dataBoard': { path: '/v1/admin/dashboard/overview' },
  'tool/dataBoard/index': { path: '/v1/admin/dashboard/overview' },
  'tool/dataBoard/class': { path: '/v1/admin/dashboard/overview' },
  'tool/dataBoard/fenxiabiao': { path: '/v1/admin/dashboard/overview' },
  'tool/dataBoard/getAuth': { path: '/v1/admin/dashboard/overview' },
