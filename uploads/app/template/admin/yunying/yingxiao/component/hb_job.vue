<template>
    <div class="setUpload">
        <div class="uploadTable">
            <div class="playbillHeader">
                <div class="playbillHeaText">
                    ...
                    <span>{yun:}t key='admin_01083'{/yun}</span>
                </div>
            ...
            <div class="playbillHeader">
                <div class="playbillHeaText">
                    <span class="span1">{yun:}t key='admin_01065'{/yun}</span>
                    <span>{yun:}t key='admin_01084'{/yun}</span>
                </div>
            </div>
            <div class="playbilCont">
                <div class="playbilName">
                    <span>{yun:}t key='admin_01085'{/yun}</span>
                </div>
        ...
        <div class="modluDrawer">
            <el-dialog title="{yun:}t key='admin_01086'{/yun}" width="500px" :visible.sync="dialogAdd" :modal-append-to-body="false">
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="saveWhb">{yun:}t key='common.submit'{/yun}</el-button>
                </div>
            </el-dialog>
        </div>
    </div>
