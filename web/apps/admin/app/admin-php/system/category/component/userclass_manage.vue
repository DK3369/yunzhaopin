<template>
    <div class="moduleElenAlCategorySub">
                ...
                <el-table-column :label="lc('admin_system_00097')" property="name">
                    <template #default="scope">
                        ...
                        <span v-else>
                            ...
                            <template v-else>
                                &emsp;&emsp;┗{{ catLabel(scope.row) }}<img @click="editData(scope)" class="editIcon" src="/admin/php-admin/images/bine.png" alt="" style="margin-left: 4px;" width="14" height="14">
                            </template>
                        </span>
                    </template>
                </el-table-column>
        ...
        <el-dialog :title="lc('admin_system_00124')" width="40%" v-model="addVisible" :modal-append-to-body="false" :append-to-body="true">
