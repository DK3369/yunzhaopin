<template>
    <!-- Member > Company > Verification & Review: Company environment review -->
    <div class="moduleElHight">
        ...
        <!-- Edit dialog -->
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_00632')" :visible.sync="editVisible" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
                <div>
                    <div class="wxsettip_small">{{ lc('admin_00630') }}</div>
                    <el-input placeholder="" v-model="ruleForm.name" :disabled="true"></el-input>
                    <div class="wxsettip_small ">{{ lc('admin_00631') }}</div>
    ...
    methods: {
        ...
        handleStatus(scope, isMore) {
            if (isMore) {
                ...
                this.titleStatus = lc('admin_user_company_00060');
                let _this = this;
