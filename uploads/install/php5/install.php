...
<div class="main">
    <textarea class="pact" readonly="readonly">
        安装协议： 本授权协议适用且仅适用于PHPYUN.'.VERSION.' 版本，OV6拥有对本授权协议的最终解释权。 I. 协议许可的权利
        1. 您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途(包括个人用户：不具备法人资格的自然人，以个人名义从事网络威客交易；非盈利性用途：从事非盈利活动的商业机构及非盈利性组织，将PHPYUN
        人才系统仅用于产品演示、展示及发布，而并不是用来买卖及盈利的运营活动的) 2. 您可以在协议规定的约束和限制范围内修改 OV6人才网系统
        ...
        人才系统 的整体或任何部分，未经书面许可，网站标题的Powered by OV6.都必须保留，而不能清除或修改。 4. 如果您未能遵守本协议的条款，您的授权将被终止，所被许可的权利将被收回，并承担相应法律责任。
        ...
        3. OV6不对使用本软件构建的人才系统中的文章或任务信息承担责任，但在不侵犯用户隐私信息的前提下，保留以任何方式获取用户及商品信息的权利。
        有关 phpyun人才网系统! 最终用户授权协议、商业授权与技术服务的详细内容，均由PHPYUN 官方网站独家提供。 OV6拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装
...
<div class="step">
    ...
    <div class="server_2">
        <div class="info">
            ...
            <p>
                OV6人才系统致力于帮助站长提高网站流量，增强网站运营能力，增加网站收入。
            </p>
            <p>
                OV6人才系统目前免费提供了QQ互联、整合UC、多套模板、邮件提醒等功能。OV6人才系统将陆续提供更多优质的服务项目。
            </p>
            <p style="color:#999;">
                大家在使用过程中，可以通过论坛向我们反馈意见及BUG。
                <a href="https://www.ov6.com/bbs" target="_blank">
                    论坛地址
                </a>
            </p>
            <br>
