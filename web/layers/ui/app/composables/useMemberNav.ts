export function useMemberNav() {
  ...
  const userItems = computed(() => [
    ...
    { to: '/user/finance', label: t('wap_user_00213') },
  ...
  const comItems = computed(() => [
    ...
    { to: '/redeem/orders', label: t('common_06524') },
    { to: '/com/broadcasts', label: t('common.message') },
    { to: '/com/warnings', label: t('member_com_00148') },
