<?php /* Smarty version Smarty-3.1.21-dev, created on 2026-04-22 17:44:48
         compiled from "/www/wwwroot/zzzz.com/uploads/app/template/member/com/jobserver.htm" */ ?>
<?php /*%%SmartyHeaderCode:124942665069e8989025da92-08992030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1eb1acd46dda833531a18c083fb8f061944121e7' => 
    array (
      0 => '/www/wwwroot/zzzz.com/uploads/app/template/member/com/jobserver.htm',
      1 => 1706496289,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '124942665069e8989025da92-08992030',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69e8989025f306_90101363',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69e8989025f306_90101363')) {function content_69e8989025f306_90101363($_smarty_tpl) {?><div id="promote_div" style="display: none;">
    <div class="set_tips">
        ...
        <div class="set_tips_p" id='promote_tc'> 您的套餐内置顶职位余量为：<span class="set_tips_n"><?php echo $_smarty_tpl->tpl_vars['statis']->value['top_num'];?>
</span>天</div>
...
<div id="reserve_box" style="display:none;">
    <form class="layui-form">
        <div class="aisx_job_left">
            ...
            <div class="aisx_job_list">
                <span class="aisx_job_name">刷新间隔：</span>
                <div class="layui-input-inline" style="width: 152px;height: 35px;position: relative;border-radius: 3px;margin-left: 20px;">
                    <select name="intervalId" id="intervalId" lay-filter="intervalId">
                        <option value="">请选择刷新间隔</option>
                        <option value="60" selected>每隔1小时刷新</option>
                        <option value="120">每隔2小时刷新</option>
                        <option value="180">每隔3小时刷新</option>
                        <option value="240">每隔4小时刷新</option>
                        <option value="300">每隔5小时刷新</option>
                        <option value="360">每隔6小时刷新</option>
                        <option value="420">每隔7小时刷新</option>
                        <option value="480">每隔8小时刷新</option>
                        <option value="1">自定义刷新间隔</option>
                    </select>
                </div>
            </div>
            <div class="aisx_job_list" style="display: none;" id="intervalDiv">
                <span class="aisx_job_name"></span>
                <div class="sx_controls">
                    <input type="text" id="interval" onblur="checkInterval(this);" placeholder="自定义" maxlength="4" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'')" class="sx_text" />
        ...
        <div class="clear"></div>
        <div class="aisx_zy">
            剩余刷新资源 <span class="aisx_zy_n"><?php echo $_smarty_tpl->tpl_vars['statis']->value['upJobNum'];?>
</span> 份
            单个职位可预约 <span class="aisx_zy_n"><?php echo intval($_smarty_tpl->tpl_vars['statis']->value['upJobNum']/$_smarty_tpl->tpl_vars['config']->value['sy_reserve_refresh_price']);?>
</span> 次自动刷新
            <?php if ($_smarty_tpl->tpl_vars['statis']->value['rating_type']==1) {?><a href="index.php?c=right&act=added&id=<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_reserve_service_id'];?>
" target="_blank" class="aisx_zy_buy">购买资源</a><?php }?>
        </div>
...
>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('select(intervalId)', function(data){
            if (data.value == 1){
    ...
    function checkInterval(obj) {
        ...
        var minInterval = '<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_reserve_refresh_interval'];?>
',
    ...
    function setReserveRefreshJob() {
        ...
        var num =   '<?php echo $_smarty_tpl->tpl_vars['statis']->value['upJobNum']/$_smarty_tpl->tpl_vars['config']->value['sy_reserve_refresh_price'];?>
';
