        ...
        <div class="uploadTable">
            <table class="tableVue">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="TableTite">{{ lc('member_com_00149') }}</div>
                        </td>
                        <td>
                            <div class="TableButn">
                    ...
                    <tr>
                        <td>
                            <div class="TableTite">{{ lc('admin_01087') }}</div>
                        </td>
                        <td>
                            <div class="TableButn">
                                <el-radio v-model="ruleForm.sy_haibao_web_type" label="1">{{ lc('admin_system_00432') }}</el-radio>
                                <el-radio v-model="ruleForm.sy_haibao_web_type" label="2">LOGO</el-radio>
                                <el-radio v-model="ruleForm.sy_haibao_web_type" label="3">{{ lc('admin_01088') }}</el-radio>
                            </div>
                            <!-- 选择文字时显示的内容 -->
                            <div v-if="ruleForm.sy_haibao_web_type == 1" class="TableButn" style="margin-top: 12px;">
                                <el-input v-model="ruleForm.sy_haibao_web_name" :placeholder="lc('admin_01090')"></el-input>
                            </div>
                            <!-- 选择logo时显示的内容 -->
