...
pub async fn delete_product(state: &AppState, user: &AuthenticatedUser, id: u64) -> AppResult<()> {
...
pub async fn delete_news(state: &AppState, user: &AuthenticatedUser, id: u64) -> AppResult<()> {
