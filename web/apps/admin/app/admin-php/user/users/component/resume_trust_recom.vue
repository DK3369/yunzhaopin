<template>
	<div class="moduleElHight">
		<div class="moduleSeachbig">
			...
			<div class="tableSeachInpt tableSeachInptsmall">
				<el-input v-model="searchForm.keyword" :placeholder="lc('admin_user_weipin_00003')" size="small"
					...
					<template #prepend><el-select v-model="searchForm.type" size="small" :placeholder="lc('admin_00490')">
		...
		<div class="moduleElTable"
       	...
       	<div class="modulePaging">
			<div>
				...
				<el-button @click="batch('rec')" size="small">{{ lc('admin_user_00237') }}</el-button>
			</div>
		...
		<div class="modluDrawer">
			...
			<el-dialog :title="lc('admin_00494')" v-model="dialogSend" center append-to-body width="12%">
