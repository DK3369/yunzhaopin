            ...
            <el-tab-pane :label="lc('wap_user_00341')" name="first">
              <div class="shshow_p">
                <div class="" v-if="info.welfare_n">{{ lc('admin_00644') }}
                  <el-tag v-for="(item, index) in info.welfare_n" :key="index" size="small"
            ...
            <el-tab-pane :label="lc('wap_01536')" name="second">
              ...
              <div v-if="total > 0" class="modulePagNum">
                <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
                  v-model:current-page="searchForm.page" :page-sizes="pageSizes" layout="total, sizes, prev, pager, next, jumper" :total="total">
                </el-pagination>
              </div>
            </el-tab-pane>
          </el-tabs>
