...
$dict = [
    ...
    '请填写域名备注' => 'Please enter domain note', '请选择要删除的管理员权限组' => 'Please select admin groups to delete',
    '确定现在执行该任务？' => 'Execute this task now?', '请先设置Web端Key' => 'Please set Web API key first',
    '请填写链接标题' => 'Please enter link title', '请选择站点下使用范围' => 'Please select site scope',
    ...
    '请输入回答内容' => 'Please enter answer content', '请选择问答类别' => 'Please select Q&A category',
    ...
    '请填写图片名称' => 'Please enter image name', '请选择参会企业！' => 'Please select participating companies!',
    '请选择展位！' => 'Please select booth!', '请选择用户名称' => 'Please select username',
    ...
    '请填写商品名称！' => 'Please enter product name!', '请选择商品类别！' => 'Please select product category!',
    ...
    '请选择广告位置！' => 'Please select ad placement!', '请选择广告类型！' => 'Please select ad type!',
    '请选择消费模式！' => 'Please select billing mode!', '请输入购买金额！' => 'Please enter purchase amount!',
    '请选输入天数！' => 'Please enter number of days!', '广告名称不能为空！' => 'Ad name cannot be empty!',
    '请选择一种广告类型！' => 'Please select an ad type!', '请填写文字信息！' => 'Please enter text content!',
    '复制失败' => 'Copy failed', '确定删除该海报？' => 'Delete this poster?', '网站名称不能大于12个字符' => 'Site name cannot exceed 12 characters',
    '确定更新数据？' => 'Update data?', '请选择用户类型' => 'Please select user type', '请输入自定义邮箱' => 'Please enter custom email',
    '请输入邮件内容' => 'Please enter email content', '请选择发送信息的用户' => 'Please select users to send to',
