        ...
        <div class=" moduleTable">
            <table class="tableVue">
                ...
                <tr align="left">
                    ...
                    <th width="600">{{ lc('member_user_00181') }}</th>
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00251') }}</div>
                    </td>
                    <td>
                        <div class="TableInpt">
                            <el-date-picker v-model="locoy_config.locoy_job_sdate" type="date" :placeholder="lc('admin_00346')" style="width: 187px;"></el-date-picker>
                        </div>
                    </td>
                    <td>
                        <div class="TableShuom">
				...
				<tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00240') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_hy" :placeholder="lc('wap_user_00100')" style="width: 187px;">
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00249') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_job1" :placeholder="lc('wap_user_00100')" @change="handelJobOneOption">
                                <el-option v-for="job1 in jobOne" :key="job1.value" :label="job1.label" :value="job1.value"></el-option>
                            </el-select>
                            <el-select v-model="locoy_config.locoy_job1_son" :placeholder="lc('wap_user_00100')" style="margin-left: 20px;" @change="handelJobTwoOption">
                                <el-option v-for="job2 in jobTwo" :key="job2.value" :label="job2.label" :value="job2.value"></el-option>
                            </el-select>
                            <el-select v-model="locoy_config.locoy_job_post" :placeholder="lc('wap_user_00100')" style="margin-left: 20px;" @change="handelJobThreeOption">
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00242') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_province" :placeholder="lc('wap_user_00100')" @change="handelCityOneOption">
                                <el-option v-for="city1 in cityOne" :key="city1.value" :label="city1.label" :value="city1.value"></el-option>
                            </el-select>
                            <el-select v-model="locoy_config.locoy_job_city" :placeholder="lc('wap_user_00100')" style="margin-left: 20px;" @change="handelCityTwoOption">
                                <el-option v-for="city2 in cityTwo" :key="city2.value" :label="city2.label" :value="city2.value"></el-option>
                            </el-select>
                            <el-select v-model="locoy_config.locoy_job_three" :placeholder="lc('wap_user_00100')" style="margin-left: 20px;" @change="handelCityThreeOption">
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00250') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-input v-model="locoy_config.locoy_minsalary" @input="inputIntNumber($event, 'locoy_config', 'locoy_minsalary')" :placeholder="lc('wap_user_00013')" style="width: 187px;">
                                <template slot="append">{{ lc('common_02056') }}</template>
                            </el-input>
                            <el-input v-model="locoy_config.locoy_maxsalary" @input="inputIntNumber($event, 'locoy_config', 'locoy_maxsalary')" :placeholder="lc('wap_user_00014')" style="width: 187px; margin-left: 20px;">
                                <template slot="append">{{ lc('common_02056') }}</template>
                            </el-input>
                        </div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00247') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-input :placeholder="lc('wap_com_00333')" v-model="locoy_config.locoy_com_number" @input="inputIntNumber($event, 'locoy_config', 'locoy_com_number')" style="width: 187px;">
                                <template slot="append">{{ lc('common_02051') }}</template>
                            </el-input>
                        </div>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00248') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_edu" :placeholder="lc('wap_user_00100')" style="width: 187px;">
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00244') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_exp" :placeholder="lc('wap_user_00100')" style="width: 187px;">
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00245') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <div class="TableSelect" style="display: flex;align-items: center;">
                                <el-input v-model="locoy_config.locoy_min_age" @input="inputIntNumber($event, 'locoy_config', 'locoy_min_age')" :placeholder="lc('wap_com_00285')" style="width: 187px;">
                                    <template slot="append">{{ lc('home.age_suffix') }}</template>
                                </el-input>
                                <el-input v-model="locoy_config.locoy_max_age" @input="inputIntNumber($event, 'locoy_config', 'locoy_max_age')" :placeholder="lc('wap_com_00308')" style="width: 187px; margin-left: 20px;">
                                    <template slot="append">{{ lc('home.age_suffix') }}</template>
                                </el-input>
                            </div>
                        </div>
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00246') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_sexs" :placeholder="lc('wap_user_00100')" style="width: 187px;">
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00243') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_marriage" :placeholder="lc('wap_user_00100')" style="width: 187px;">
                ...
                <tr>
                    <td>
                        <div class="TableTite">{{ lc('admin_tool_00241') }}</div>
                    </td>
                    <td>
                        <div class="TableSelect" style="display: flex;align-items: center;">
                            <el-select v-model="locoy_config.locoy_job_report" :placeholder="lc('wap_user_00100')" style="width: 187px;">
