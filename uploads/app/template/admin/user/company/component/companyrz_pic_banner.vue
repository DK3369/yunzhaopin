<template>
    ...
    <div class="moduleElHight">
        ...
        <!--修改弹出框-->
        <div class="modluDrawer">
            <el-dialog title="{yun:}t key='admin_00628'{/yun}" :visible.sync="editVisible" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
                <div>
...
module.exports = {
    ...
    data: function () {
        return {
            ...
            titleStatus: "{yun:}t key='admin_user_company_00058'{/yun}",
            // Update
            info: {},
            editVisible: false,
            ruleForm: {
    ...
    methods: {
        ...
        handleStatus(scope, isMore) {
            if (isMore) {
                ...
                this.titleStatus = "{yun:}t key='admin_user_company_00058'{/yun}";
                let _this = this;
