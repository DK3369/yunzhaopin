    ...
    <div class="moduleElHight">
        <div class="moduleSeachbig" v-if="cansearch">
            <div class="tableSeachInpt">
                <el-select v-model="type" size="small" :placeholder="lc('wap_com_00030')">
        ...
        <div class="modluDrawer">
            <el-drawer :title="lc('admin_user_company_00030')" :append-to-body="true" v-model="showhtpic" :destroy-on-close="true" size="85%">
                <com_htimg :oid="curr_id" style="margin-left:10px;"></com_htimg>
            </el-drawer>
        </div>
        <div class="modluDrawer" v-if="curr_dtl">
            <el-drawer :title="lc('admin_user_company_00048')" :append-to-body="true" v-model="dtlVisible" :destroy-on-close="true"
                       size="530px">
                <div>
...
<script>
import ComHtimg from './com_htimg.vue'
