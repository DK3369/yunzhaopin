    ...
    <div class="moduleElHight">
        <div class="moduleSeachbig">
            ...
            <div class="tableSeachInpt tableSeachInptsmalltwo">
                <el-date-picker v-model="search.time" type="daterange" range-separator="{yun:}t key='admin_company_00019'{/yun}" start-placeholder="{yun:}t key='admin_00343'{/yun}" end-placeholder="{yun:}t key='admin_00344'{/yun}" size="mini" @change="doUserQuery">
                </el-date-picker>
            </div>
            <div class="tableSeachInpt tableSeachInptsmall">
            ...
            <div class="tableSeachInpt tableSeachInptsmall">
                <el-select v-model="search.parrs" size="small" slot="prepend" placeholder="{yun:}t key='wap_com_00030'{/yun}" clearable @change="doUserQuery">
                    ...
                    <el-option label="{yun:}t key='common.delete'{/yun}" value="3"></el-option>
        ...
        <div class="moduleElTable" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe @selection-change="selectChange" ref="multipleTable" :header-cell-style="{ background: '#f5f7fa', color: '#606266' }" @sort-change="shortChange" v-loading="loading">
                ...
                <el-table-column prop="zzh" label="{yun:}t key='wap_com_00157'{/yun}" min-width="100" show-overflow-tooltip>
                ...
                <el-table-column prop="ctime_ymd" label="{yun:}t key='wap_js_00088'{/yun}" width="150" sortable="custom"></el-table-column>
                <el-table-column label="{yun:}t key='member_user_00048'{/yun}" width="100" fixed="right">
                    <template slot-scope="scope">
                        <div class="cz_button">
...
module.exports = {
    ...
    methods: {
        ...
        del: function(detail) {
            ...
            let msg = "{yun:}t key='admin_00333'{/yun}";
        ...
        batchDel: function() {
            let ids = this.idsArr;
            if (!ids.length) {
                message.error("{yun:}t key='admin_company_00021'{/yun}");
                return
            }
            let _this = this,
                params = {};
