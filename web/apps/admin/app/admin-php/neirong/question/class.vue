...
<div id="cityfl" class="moduleElenAl">
    <div class="moduleSeachs">
        <div class="moduleSeachleft">
            <div class="  newsinput">
                <el-input :placeholder="lc('admin_00340')" size="small" prefix-icon="el-icon-search"
        ...
        <div class="nrtopbtn">
            <el-button type="primary" icon="el-icon-document-add" size="small"
                       @click="openAdd('')">{{ lc('admin_00222') }}</el-button>
            <el-button type="" size="small" v-if="pid > 0" @click="childClass(0)">{{ lc('common_02039') }}</el-button>
        </div>
    </div>
        ...
        <el-table :data="list" :default-sort="{prop: 'date', order: 'descending'}" stripe border
            ...
            <el-table-column :label="lc('member_user_00048')" width="200" fixed="right">
                <template #default="scope">
                    <div class="cz_button">
                        <el-button size="small" plain @click="openManage(scope.row)">{{ lc('wap_com_00304') }}</el-button>
    ...
    <div class="modluDrawer">
        <el-drawer :title="detail.id ? lc('admin_00221') : lc('admin_00222')" v-model="drawerAdd" append-to-body :show-close="true"
                   :with-header="true" size="45%">
            <add :refresh="random" :id="detail.id ? detail.id : ''" @child-event="closeAdd"></add>
        </el-drawer>
        <el-drawer :title="lc('admin_00216')" v-model="drawerManage" append-to-body :show-close="true"
...
<script>
import ClassAdd from './component/class_add.vue'
import ClassManage from './component/class_manage.vue'
