...
> **当日提纲，不是架构。** 文中「未映射 304 / rec / interview save」等已过期。现状读 [ARCHITECTURE.md](../ARCHITECTURE.md)；映射以 `web/apps/admin/app/utils/phpMap.ts` 为准。
>
> 下一轮不要按本文当总图。摘要见 [ADMIN_PROGRESS.md](../ADMIN_PROGRESS.md)。不双写 `.cursor/plans/`。
