...
pub struct AdminJobRow {
    ...
    pub xsdate: i64,
    pub xsdate_n: String,
    /// PHP Vue `company_job.vue` `top_time_n`.
    pub top_time_n: String,
    pub rec_time: i64,
    pub rec_time_n: String,
    pub urgent_time: i64,
    pub urgent_time_n: String,
    pub isrec: bool,
    pub sdate: i64,
    pub sdate_n: String,
    pub lastupdate: i64,
...
fn row_from(
    ...
    AdminJobRow {
        ...
        xsdate: j.xsdate,
        xsdate_n: fmt_dt(j.xsdate),
        top_time_n: fmt_dt(j.xsdate),
        rec_time: j.rec_time,
        rec_time_n: fmt_dt(j.rec_time),
        urgent_time: j.urgent_time,
        urgent_time_n: fmt_dt(j.urgent_time),
