<template>
    <div class="moduleElHight" style="padding: 0 20px;">
        ...
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_00234')" width="500px" v-model="dialogAudit" append-to-body>
            ...
            <el-dialog :title="lc('admin_00792')" width="500px" v-model="dialogEdit" append-to-body>
                <div class="toolClasDia fenpeizhand">
                    <div class="toolClasList">
                        <div class="toolClasTite">
