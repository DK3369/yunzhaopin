    ...
    <div class="moduleElHight">
        ...
        <div class="moduleElTable" :class="{ 'modulElTableGai': tableHig }" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe
                ...
                <el-table-column prop="name" label="{yun:}t key='wap_00529'{/yun}">
                </el-table-column>
                <el-table-column prop="username" label="{yun:}t key='admin_user_00140'{/yun}">
                </el-table-column>
                <el-table-column prop="wenjian" label="{yun:}t key='admin_user_00190'{/yun}">
        ...
        <div class="modluDrawer">
            <el-dialog title="{yun:}t key='admin_00465'{/yun}" :visible.sync="statusVisible" :with-header="true" :modal-append-to-body="false"
                ...
                <div>
                    ...
                    <div class="wxsettip_small ">{yun:}t key='admin_user_00189'{/yun}</div>
                    <div class="zzrz_img">
        ...
        <!--修改弹出框-->
        <div class="modluDrawer">
            <el-dialog title="{yun:}t key='admin_00466'{/yun}" :visible.sync="editVisible" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
                <div class="wxsettip_small ">{yun:}t key='wap_00529'{/yun}</div>
                <el-input placeholder="" v-model="info.name" :disabled="true"></el-input>
                <div class="wxsettip_small ">{yun:}t key='admin_00464'{/yun}</div>
