<template>
	<div class="moduleElHight">
		<div class="tableDome_tip">
			<el-alert :title="lc('admin_tool_00375')" type="success" :closable="false">
			</el-alert>
		</div>
					...
					<table class="tableVue">
						...
						<tbody>
							<tr v-for="item in con.configarr" :key="item.tpl">
								...
								<td>
									<div class="TableButn">
										<el-switch v-model="item.config_val" :active-text="lc('admin_tool_00468')" :inactive-text="lc('admin_tool_00469')"
		...
		<div class="modluDrawer">
			<el-drawer :title="lc('admin_tool_00374')" :visible.sync="addshow" :modal-append-to-body="false" :show-close="true"
