    ...
    <div class="moduleElHight">
        <div class="moduleSeachbig">
            ...
            <div class="tableSeachInpt">
                <el-input :placeholder="lc('wap_user_00076')" size="small" prefix-icon="el-icon-search" v-model="search.content" clearable>
                </el-input>
            </div>
            <div class="tableSeachInpt tableSeachInptsmalltwo">
                <el-date-picker v-model="search.time" type="daterange" :range-separator="lc('admin_company_00019')" :start-placeholder="lc('admin_00343')" :end-placeholder="lc('admin_00344')" size="small" @change="doUserQuery">
                </el-date-picker>
            </div>
            <div class="tableSeachInpt tableSeachInptsmall">
            ...
            <div class="tableSeachInpt tableSeachInptsmall">
                <el-select v-model="search.parrs" size="small" :placeholder="lc('wap_com_00030')" clearable @change="doUserQuery">
                    ...
                    <el-option :label="lc('common.delete')" value="3"></el-option>
        ...
        <div class="moduleElTable" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe @selection-change="selectChange" ref="multipleTable" :header-cell-style="{ background: '#f5f7fa', color: '#606266' }" @sort-change="shortChange" v-loading="loading">
                ...
                <el-table-column prop="zzh" :label="lc('wap_com_00157')" min-width="100" show-overflow-tooltip>
                ...
                <el-table-column prop="ctime_ymd" :label="lc('wap_js_00088')" width="150" sortable="custom"></el-table-column>
                <el-table-column :label="lc('member_user_00048')" width="100" fixed="right">
                    <template #default="scope">
                        <div class="cz_button">
        ...
        <div class="modulePaging">
            ...
            <div class="modulePagNum">
                <el-pagination :total="total" @current-change="userPageChange" :page-size="pageSize" :page-sizes="pageSizes" @size-change="userPageSizeChange" v-model:current-page="page" layout="total, sizes, prev, pager, next, jumper">
                </el-pagination>
            </div>
        </div>
    </div>
...
export default {
    ...
    data: function() {
        return {
            ...
            operasArr: {
                ...
                4: lc('resume_00029'),
                5: lc('wap_user_00193'),
                6: "{{ lc('wap_00574') }}/{{ lc('common_01991') }}",
                7: lc('wap_00456'),
                8: lc('member_user_00226'),
                11: lc('admin_user_00152'),
                12: lc('member_com_00093'),
                14: "{{ lc('member_com_00293') }}/{{ lc('common_01937') }}",
                15: lc('admin_user_00153'),
                16: lc('wap_js_00081'),
                17: lc('common_06524'),
    ...
    methods: {
        ...
        batchDel: function() {
            let ids = this.idsArr;
            if (!ids.length) {
                message.error(lc('admin_company_00021'));
                return
            }
            let _this = this,
                params = {};
