...
const H5_DARK = ['/user/finance', '/user/pay', '/user/cashier', '/user/integral', '/user/rewards', '/user/integral-rules', '/com/pay', '/com/cashier', '/com/integral', '/com/orders', '/com/record', '/com/rewards', '/com/integral-rules', '/com/services']
