<template>
    <div class="moduleElHight">
        <div class="moduleElSearchInf">
            <div class="moduleElTabInpt" style="flex-wrap: wrap;">
                <div class="moduleInptList moduleInptWidt">
                    <el-input size="small" :placeholder="lc('admin_user_weipin_00003')" @keyup.enter="search" v-model="searchForm.keyword" clearable class="input-with-select">
                        ...
                        <div class="moduleElTaCaoz">
                            ...
                            <el-popover placement="bottom" width="60" trigger="hover">
                                <div class="moduleMores">
                                    ...
                                    <el-button size="small" @click="del(scope.$index)" type="danger">{{ lc('common.delete') }}</el-button>
                                </div>
                                <template #reference><el-button size="small" @click="visible = !visible">{{ lc('common.more') }}</el-button></template>
                            </el-popover>
                        </div>
                    </template>
                </el-table-column>
        ...
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_user_weipin_00032')" v-model="dialogAudit" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="500px">
                <div class="toolClasDia fenpeizhand">
        ...
        <div class="modluDrawer">
            <el-drawer :title="lc('member_com_00028')" v-model="drawerDetail" :modal-append-to-body="false" size="640px">
            ...
            <el-drawer :title="lc('wap_js_00066')" v-model="drawerAdd" :modal-append-to-body="false" size="40%">
