...
export const PHP_ADMIN_MAP: Record<string, PhpAction> = {
  ...
  'tool/dataCollection/setLocoyConfig': { path: '/v1/admin/site-settings/batch', transformReq: wrapItems },
...
const MODULE_ROUTES: Record<string, ModuleRoutes> = {
  ...
  'user/users_member': { list: '/v1/admin/php-content/user-gap/user-index', status: '/v1/admin/users/status', del: '/v1/admin/users/status' },
