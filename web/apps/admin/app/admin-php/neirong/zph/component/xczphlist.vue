    ...
    <div class="moduleElHight">
        <div class="moduleSeachs">
            <div class="moduleSeachInpt">
                ...
                <el-select v-model="status" size="small" :placeholder="lc('wap_com_00406')" clearable style="margin-right: 10px; text-align: left;" @change="search">
            ...
            <div class="moduleSeachButn">
                <div class="tableSeachInpt" style="margin-bottom: 0;">
                    <el-button type="primary" icon="el-icon-document-add" size="small" @click="addzph({id: ''})">{{ lc('admin_00848') }}</el-button>
                </div>
            </div>
        </div>
                    ...
                    <template #default="scope">
                        <div style="padding-top: 10px;">
                            ...
                            <el-tooltip v-if="scope.row.booking > 0" :content="lc('admin_00316')" placement="top-end">
                                <el-button @click="showComList(scope.row, 3)" type="text">
                ...
                <el-table-column :label="lc('member_user_00048')" fixed="right" width="140">
                    <template #default="scope">
                        <div class="cz_button">
                            ...
                            <el-button size="small" @click="statusSet(scope.row)">{{ lc('member_user_00181') }}</el-button>
                        </div>
                        <div class="cz_button" style="margin-top: 10px;">
                            <el-button size="small" @click="addzph(scope.row)">{{ lc('wap_js_00073') }}</el-button>
        ...
        <div class="modulePaging">
            <div>
                ...
                <el-button @click="fpAllBottom" size="small">{{ lc('admin_user_00279') }}</el-button>
            </div>
        ...
        <!--添加招聘会-->
        <el-drawer :title="lc('admin_00317')" v-model="editdrawer" :modal-append-to-body="false" :show-close="true" :with-header="true" size="60%">
        ...
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_00855')" v-model="drawerstatus" :with-header="true" :modal-append-to-body="false" :show-close="true" width="450px">
        ...
        <!--参会企业-->
        <el-drawer :title="curr_data.title + ' - ' + lc('wap_00559')" v-model="comdrawer" :modal-append-to-body="false" append-to-body size="80%" @close="closeComList">
                ...
                <div class="modulemoreSeach">
                    <div class="moduleSeachbig">
                        <div class="tableSeachInpt tableSeachInptsmall newsinput">
                            <el-select v-model="com_status" size="small" :placeholder="lc('wap_com_00406')" clearable @change="comSearch">
                        ...
                        <div class="tableSeachInpt">
                            <el-button type="primary" icon="el-icon-search" size="small" @click="comSearch">{{ lc('admin_user_weipin_00049') }}</el-button>
                        </div>
                    </div>
                    <div class="moduleSeachButn">
                        <div class="tableSeachInpt" style="padding-right:10px; ">
                            <el-button type="primary" icon="el-icon-document-add" size="small" @click="comadd">{{ lc('admin_00850') }}
                            </el-button>
                            <!--<el-button type="primary" plain icon="el-icon-plus" size="small">导出参会企业</el-button>-->
                        </div>
                    </div>
                </div>
        ...
        <!--参会企业添加-->
        <el-drawer :title="lc('admin_00850')" v-model="drawercomadd" append-to-body :modal-append-to-body="false" size="80%">
        ...
        <el-drawer :title="lc('admin_00856')" v-model="zphdrawerimg" :modal-append-to-body="false" append-to-body size="80%">
                        ...
                        <div class="shshow">
                            ...
                            <div class="shshow_p">
                                <div class="" v-if="info.welfare">{{ lc('admin_00644') }}
                                    <el-tag style="margin-right: 5px;" v-for="(item,index) in info.welfare_n" size="small" :key="index">
                                        {{item}}
                                    </el-tag>
                                </div>
        ...
        <!--分配站点弹窗-->
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_user_weipin_00029')" width="300px" v-model="drawerfp" :modal-append-to-body="false">
...
<script>
import Xczphimg from './xczphimg.vue'
import Xczphadd from './xczphadd.vue'
