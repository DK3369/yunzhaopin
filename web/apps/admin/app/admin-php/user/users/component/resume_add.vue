<template>
    <div class="moduleElHight">
        ...
        <div class="modluDrawer">
            <!--新增简历-->
            <el-drawer :title="lc('admin_user_00193')" v-model="drawerEdit" append-to-body :before-close="handleClose" :wrapper-closable="false" size="70%">
...
<script>
import ResumeEdit from './resume_edit.vue'
