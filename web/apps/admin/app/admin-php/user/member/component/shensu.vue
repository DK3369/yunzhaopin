	...
	<div class="moduleElHight">
		<div class="moduleSeachbig">
			...
			<div class="tableSeachInpt">
				<el-input :placeholder="lc('admin_00340')" size="small" @keyup.enter="doUserQuery" prefix-icon="el-icon-search" v-model="search.keyword" clearable>
				</el-input>
			</div>
			<div class="tableSeachInpt">
		...
		<div class="moduleElTable" :class="{ 'moduleElTableHig': tableHig }" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
			<el-table :data="tableData" style="width: 100%" stripe @selection-change="selectChange" ref="multipleTable"
                ...
                <el-table-column :label="lc('member_user_00048')" width="240" fixed="right">
                    <template #default="scope">
                        <div class="cz_button">
                            <el-button  v-if="scope.row.appealstate == 1"   size="small" plain @click="set(scope.row)">{{ lc('wap_js_00094') }}</el-button>
                            <el-button   size="small" plain @click="resetPassword(scope.row)">{{ lc('admin_user_00137') }}</el-button>
                            <el-button   size="small" plain @click="detailFun(scope.row)">{{ lc('member_com_00380') }}</el-button>
		...
		<div class="modulePaging">
			<div>
                ...
                <el-button @click="batchDel" size="small">{{ lc('member_com_00055') }}</el-button></div>
		...
		<div class="modluDrawer">
			<el-drawer :title="lc('admin_00454')" v-model="detaildrawer" :append-to-body="true" size="620px">
		...
		<!-- Send message -->
		<div class="modluDrawer">
			<el-dialog :title="title" v-model="sendInfodrawer" :append-to-body="true" width="450px">
