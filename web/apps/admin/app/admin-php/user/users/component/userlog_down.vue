    ...
    <div class="moduleElHight">
        <div class="moduleElSearchInf">
            <div class="moduleElTabInpt" style="flex-wrap: wrap;">
                ...
                <div class="tableSeachInpt tableSeachInptsmalltwo">
                    <el-date-picker v-model="searchForm.times" type="daterange" align="right" unlink-panels :range-separator="lc('admin_company_00019')" :start-placeholder="lc('admin_00521')" :end-placeholder="lc('admin_00522')" :picker-options="timeOptions" value-format="YYYY-MM-dd" size="small" @change="handleTimeChange"></el-date-picker>
                </div>
        ...
        <div class="moduleElTable" :class="{ 'moduleElTableHig': tableHig }" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe
                ...
                <el-table-column :label="lc('admin_user_00261')" width="230">
                ...
                <el-table-column :label="lc('admin_user_00262')">
                    <template #default="scope">
                        <div class=" ">
                            <div class="username">
                ...
                <el-table-column prop="downtime" :label="lc('wap_com_00352')" sortable="custom">
                    <template #default="scope">{{ scope.row.downtime_n }}</template>
                </el-table-column>
