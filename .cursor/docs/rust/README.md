...
| 契约、快照、PHP 字符串 400 | [api.md](./api.md) | `doc/snapshots/`；Scalar `https://job1.ov6.com/docs/`（经 `:3001`） |
| 已合并 / 已摘除 | [api-merged.md](./api-merged.md) | 本批 deprecated HTTP 已 404；路径以 `v1_paths.txt` 为准 |
