...
pub async fn resume_sex(State(state): State<AppState>) -> AppResult<ApiResponse<Vec<DistItem>>> {
    let list = data_show_service::resume_sex_distribution(&state).await?;
    Ok(ApiResponse::data((*list).clone()))
}

#[utoipa::path(post, path = "/v1/wap/data-show/resume-edu", tag = "wap", responses((status = 200, description = "ok")))]
pub async fn resume_edu(State(state): State<AppState>) -> AppResult<ApiResponse<Vec<DistItem>>> {
...
pub async fn resume_exp(State(state): State<AppState>) -> AppResult<ApiResponse<Vec<DistItem>>> {
...
pub async fn resume_age(State(state): State<AppState>) -> AppResult<ApiResponse<Vec<DistItem>>> {
...
) -> AppResult<ApiResponse<Vec<DistItem>>> {
...
pub async fn company_scale(State(state): State<AppState>) -> AppResult<ApiResponse<Vec<DistItem>>> {
...
pub async fn user_register_trend(
    State(state): State<AppState>,
) -> AppResult<ApiResponse<Vec<TimePoint>>> {
...
pub async fn company_job_trend(
    State(state): State<AppState>,
) -> AppResult<ApiResponse<Vec<TimePoint>>> {
...
pub async fn company_login_trend(
    State(state): State<AppState>,
) -> AppResult<ApiResponse<Vec<TimePoint>>> {
