    ...
    <div class="moduleElHight">
        <div class="modulemoreSeach">
            ...
            <div class="moduleSeachButn">
                <div class="tableSeachInpt">
                    <el-button type="primary" icon="el-icon-document-add" size="small" @click="toadd({id: ''})">{{ lc('admin_00829') }}</el-button>
                </div>
            </div>
        </div>
        ...
        <div class="moduleElTable moduleElMoreLive" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe @selection-change="handleSelectionChange"
                ...
                <el-table-column :label="lc('member_user_00048')" fixed="right" width="200">
                    <template #default="scope">
                        <div class="cz_button">
                            <el-button size="small" plain @click="toadd(scope.row)">{{ lc('wap_js_00073') }}</el-button>
                            <el-button size="small" plain @click="todtl(scope.row.id)">{{ lc('admin_00294') }}</el-button>
                            <el-button type="danger" size="small" @click="delrow(scope.row.id, 1)">{{ lc('common.delete') }}</el-button>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <div class="modulePaging">
            <div>
                ...
                <el-button @click="delAllBottom(1)" size="small">{{ lc('member_com_00055') }}</el-button>
            </div>
        </div>
        <!-- 场地详细 -->
        <el-drawer :title="lc('admin_00833')" v-model="drawerdtl" append-to-body :modal-append-to-body="false" size="80%">
            <div class="moduleElHight" style="padding: 0 20px;">
                <div class="modulemoreSeach" style="width: 100%; padding-bottom: 10px;">
                    ...
                    <div class="moduleHeadrButn" >
                        <el-button type="primary" icon="el-icon-document-add" @click="toadd({id: ''})" size="small">{{ lc('admin_00823') }}
                        </el-button>
                    </div>
                </div>
                ...
                <div class="modulePaging" style="padding-left: 20px;">
                    <div class="">
                        <div class="">
                            ...
                            <el-button @click="delAllBottom(2)" size="small">{{ lc('member_com_00055') }}</el-button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modluDrawer">
            <el-drawer :title="curr_data.id ? lc('admin_vue_00121') : lc('admin_00829')" v-model="draweradd" append-to-body :modal-append-to-body="false" :show-close="true"
                        ...
                        <div class="drawerModLis" v-if="curr_data.keyid != '' || fir_id != ''">
                            ...
                            <div class="drawerModInpt">
                                <el-input v-model="curr_data.price" :placeholder="lc('admin_00837')"
                                    ...
                                    <template #append>{{ lc('wap_user_00008') }}</template>
                                </el-input>
                            </div>
                        </div>
                        <div class="drawerModLis">
