<template>
    ...
    <div class="fl_cont">
        <div class="fl_cont_categoryHeader">
            <div></div>
            <div>
                <el-button type="primary" @click="addVisible = true" icon="el-icon-document-add" size="small">{{ lc('admin_00197') }}</el-button>
            </div>
        </div>
        ...
        <el-dialog :title="lc('admin_system_00124')" width="580px" v-model="addVisible" :modal-append-to-body="false">
            <userclass_add :position="tableData" @child-event-getlist="getList"></userclass_add>
        </el-dialog>
        <div class="modluDrawer">
            <el-drawer :title="lc('wap_com_00304')" v-model="manageVisible" @close="getList" :append-to-body="true"
...
<script>
import UserclassAdd from './userclass_add.vue'
import UserclassManage from './userclass_manage.vue'
...
export default {
    ...
    components: {
        'userclass_add': UserclassAdd,
        'userclass_manage': UserclassManage,
    }
};
</script>
<style scoped>
