<?php /* Smarty version Smarty-3.1.21-dev, created on 2026-04-22 17:38:09
         compiled from "/www/wwwroot/zzzz.com/uploads/app/template/wap/joblist_vue.htm" */ ?>
<?php /*%%SmartyHeaderCode:122634064969e8970195f468-71752284%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4b4720b8b006f5de70c168a18b53d7f02589d624' => 
    array (
      0 => '/www/wwwroot/zzzz.com/uploads/app/template/wap/joblist_vue.htm',
      1 => 1703143958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '122634064969e8970195f468-71752284',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69e897019734b3_89383575',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69e897019734b3_89383575')) {function content_69e897019734b3_89383575($_smarty_tpl) {?><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/js/list_bottom.js?v=<?php echo $_smarty_tpl->tpl_vars['config']->value['cachecode'];?>
"><?php echo '</script'; ?>
>
                ...
                <a v-bind:title="item.name" :data-href="item.wapjob_url" href="javascript:void(0)" onclick="toPage(this)">
                    ...
                    <div class="newjob_info">
                        ...
                        <span class="newjob_fw">
							<img v-if="item.rec_n" src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/icon_recommend.png" alt="">
							<img v-if="item.urgent_n" src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/jp.png" alt="">
						</span>
                    </div>
                ...
                <a v-bind:title="item.com_name" :data-href="item.wapcom_url" href="javascript:void(0)" onclick="toPage(this)">
                    <div class="tab_card_bottom">
                        ...
                        <img v-if="item.hotlogo" src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/app/template/wap/images/mq.png" alt="名企" class="png" width="14" style="vertical-align:middle">
...
';
    ...
    var x = '<?php echo $_GET['mapx'];?>
';
    var y = '<?php echo $_GET['mapy'];?>
';
    //附近职位
    if (mapjob == '1') {
        var jobpage = 0;
