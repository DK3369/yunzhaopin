    ...
    <div class="moduleElHight">
                ...
                <div class="moduleInptList">
                    <el-input :placeholder="lc('admin_user_weipin_00003')" @keyup.enter.native="handleSearch" size="small" v-model="searchForm.keyword" class="input-with-select" clearable>
                        <el-select v-model="searchForm.type" slot="prepend" :placeholder="lc('wap_user_00100')">
                            <el-option :label="lc('admin_user_00266')" value="1"></el-option>
                            <el-option :label="lc('wap_01403')" value="2"></el-option>
                        </el-select>
                    </el-input>
                </div>
        ...
        <div class="moduleElTable" :class="{ 'moduleElTableHig': tableHig }" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe
                ...
                <el-table-column prop="com_name" :label="lc('wap_01403')" min-width="150" show-overflow-tooltip>
                    <template slot-scope="scope">
                        <el-link :href="scope.row.com_url" target="_blank" type="primary">{{ scope.row.com_name }}</el-link>
                    </template>
                </el-table-column>
                <el-table-column prop="username" :label="lc('admin_user_00266')" width="150">
                    <template slot-scope="scope">
                        <el-button type="text" @click="handlePreview(scope)" style="padding: 0">{{ scope.row.username }}</el-button>
                    </template>
                </el-table-column>
                <el-table-column prop="jobname" :label="lc('wap_00460')" min-width="180"></el-table-column>
                <el-table-column prop="exp" :label="lc('wap_user_00240')" width="150"></el-table-column>
                <el-table-column prop="salary" :label="lc('wap_user_00016')" width="150"></el-table-column>
                <el-table-column prop="ctime_n_n" :label="lc('member_user_00104')" width="160"></el-table-column>
