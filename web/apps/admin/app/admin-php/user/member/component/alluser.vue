    ...
    <div class="moduleElHight">
        <div class="moduleSeachbig">
            <div class="tableSeachInpt tableSeachInptsmall">
                <el-input :placeholder="lc('admin_00340')" size="small" @keyup.enter="doUserQuery" v-model="search.keyword" class="input-with-select" clearable>
            ...
            <div class="tableSeachInpt tableSeachInptsmall">
                <el-select v-model="search.source" size="small" :placeholder="lc('admin_user_00132')" clearable @change="doUserQuery">
            ...
            <div class="tableSeachInpt tableSeachInptsmall" :class="{ 'searchbutnOnff': seachbutn }">
                <el-select v-model="search.utype" size="small" :placeholder="lc('admin_user_00136')" clearable @change="doUserQuery">
                    <el-option v-for="(item,key) in userType" :key="key" :label="item.label" :value="item.value"></el-option>
                </el-select>
            </div>
            <div class="tableSeachInpt tableSeachInptsmall" :class="{ 'searchbutnOnff': seachbutn }">
                <el-select v-model="search.status" size="small" :placeholder="lc('admin_user_00133')" clearable @change="doUserQuery">
                    <el-option :label="lc('admin_user_00149')" value="1"></el-option>
                    <el-option :label="lc('admin_user_00150')" value="2"></el-option>
                </el-select>
            </div>
            <div class="tableSeachInpt tableSeachInptsmall" :class="{ 'searchbutnOnff': seachbutn }">
                <el-select v-model="search.time_type" size="small" :placeholder="lc('admin_user_00135')" clearable @change="handleTimeChange">
            ...
            <div class="tableSeachInpt tableSeachzk" :class="{ 'searchbutnKai': seachbutn }">
                <el-button type="info" class="zhankai" @click="seachbutn = !seachbutn, tableHig = !tableHig" aria-disabled="false" size="small" plain>{{ lc('admin_user_00145') }}<i class="el-icon-arrow-down el-icon--right"></i></el-button>
                <el-button type="info" class="shouqi" @click="seachbutn = !seachbutn, tableHig = !tableHig" aria-disabled="false" size="small" plain>{{ lc('admin_user_00144') }}<i class="el-icon-arrow-up el-icon--right"></i></el-button>
            </div>
        </div>
        ...
        <div class="modulePaging">
            ...
            <div class="modulePagNum">
                <el-pagination :total="total" @current-change="userPageChange" :page-size="pageSize" :page-sizes="pageSizes" @size-change="handleSizeChange" v-model:current-page="page" layout="total, sizes, prev, pager, next, jumper">
                </el-pagination>
            </div>
        </div>
        <!--修改用户弹窗-->
        <div class="modluDrawer">
            <el-drawer title=" {{ lc('admin_00441') }}" v-model="userdrawer" :append-to-body="true" size="40%">
                <div class="drawerModInfo drawerModInfoOne" style="height: calc(100% - 80px); overflow-y: auto;">
                    <div class="drawerModLis">
                        ...
                        <div class="drawerModInpt">
                            <el-select v-model="detail.usertype" size="small" :placeholder="lc('admin_user_00136')" :disabled="true">
                                <el-option v-for="(item,key) in userType" :key="key" :label="item.label" :value="item.value"></el-option>
                            </el-select>
                        </div>
                    </div>
                    ...
                    <div class="drawerModLis">
                        ...
                        <div class="drawerModInpt">
                            <el-select v-model="search.did" size="small" :placeholder="lc('admin_user_00126')" filterable>
        ...
        <!--锁定用户弹窗-->
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_00445')" v-model="usersddrawer" :append-to-body="true" width="450px">
                <div>
        ...
        <!--分配站点弹窗-->
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_user_weipin_00029')" v-model="usercitydrawer" :append-to-body="true" width="450px">
                ...
                <div>
                    ...
                    <div class="wxsettip_Sealect">
                        <el-select v-model="shareZhanArr.did" size="small" :placeholder="lc('admin_user_00126')" filterable>
                            <el-option v-for="(value,key) in dnameArr" :key="key" :label="value" :value="key"></el-option>
                        </el-select>
                    </div>
                </div>
