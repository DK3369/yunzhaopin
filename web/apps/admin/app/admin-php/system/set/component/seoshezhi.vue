<template>
    <div class="drawerModlue">
        ...
        <div class="modluDialog">
            <el-drawer :title="lc('admin_system_00374')" v-model="centerDialogVisible" :append-to-body="true" :show-close="true" :with-header="true" size="40%">
        ...
        <!-- <div class="modluDialog">
            <el-dialog :title="lc('admin_system_00374')" v-model="centerDialogVisible" :append-to-body="true" :modal="false" width="30%" center>
                <div>
                    <div class="tableDome_tip">
                        <el-alert :title="lc('admin_system_00358')" type="warning">
                        </el-alert>
