    ...
    <div class="moduleElHight">
        <div class="moduleSeachbig">
            <div class="tableSeachInpt tableSeachInptsmalltwo">
                <el-date-picker v-model="search.times" type="daterange" :range-separator="lc('admin_company_00019')" :start-placeholder="lc('admin_00343')" value-format="YYYY-MM-dd" :end-placeholder="lc('admin_00344')" size="small" @change="doUserQuery"></el-date-picker>
            </div>
            <div class="tableSeachInpt tableSeachInptsmall">
                <el-input :placeholder="lc('admin_user_00158')" @keyup.enter="doUserQuery" size="small" v-model="search.keyword" class="input-with-select" clearable>
                    <template #prepend><el-select v-model="search.type" :placeholder="lc('admin_user_00136')">
        ...
        <div class="moduleElTable" :class="{ 'moduleElTableHig': tableHig }" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe @selection-change="selectChange" ref="multipleTable" :header-cell-style="{ background: '#f5f7fa', color: '#606266' }" height="100%" @sort-change="shortChange" v-loading="loading">
                ...
                <el-table-column prop="rname" :label="lc('wap_00529')" width="150"></el-table-column>
        ...
        <div class="modulePaging">
            ...
            <div class="modulePagNum">
                <el-pagination :total="total"
                               ...
                               :page-size="pageSize" v-model:current-page="page" layout="total, sizes, prev, pager, next, jumper">
                </el-pagination>
            </div>
        </div>
    </div>
