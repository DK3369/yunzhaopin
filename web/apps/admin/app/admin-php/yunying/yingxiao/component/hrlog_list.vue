    ...
    <div class="moduleElHight">
        <div class="moduleElTabSeach">
            ...
            <div class="moduleSeachButn">
                <el-button type="primary" icon="el-icon-document-add" size="small" @click="openSet">{{ lc('wap_com_00307') }}</el-button>
            </div>
        </div>
                ...
                <el-table-column fixed="right" :label="lc('member_user_00048')" width="150">
                    <template #default="scope">
                        <div class="moduleElTaCaoz">
                            <el-button size="small" @click="updateData(scope.row.id)">{{ lc('wap_00225') }}</el-button>
                            <el-button size="small" @click="openEdit(scope.row)">{{ lc('wap_js_00073') }}</el-button>
                            <el-button size="small" @click="openHb(scope.row)">{{ lc('member_com_00270') }}</el-button>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <div class="modluDrawer">
            <el-drawer :title="lc('admin_01105')" v-model="drawerEdit" :direction="direction" :modal-append-to-body="false"
                size="500px">
        ...
        <div class="modluDrawer">
            <el-drawer :title="lc('wap_com_00307')" v-model="drawerSet" :direction="direction" :modal-append-to-body="false" size="45%">
                <div class="moduleSchools">
            ...
            <el-dialog :title="lc('member_com_00270')" class="abow_dialog" v-model="dialogHb" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="400px">
                <div class="center">
                    <img :src="hbUrl" width="360" height="640">
                </div>
                <div class="center">
                    <el-button type="primary" size="small" @click="downloadHb">{{ lc('common_02219') }}</el-button>
                </div>
            </el-dialog>
        </div>
    </div>
