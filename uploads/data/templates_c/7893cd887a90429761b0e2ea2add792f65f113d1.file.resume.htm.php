<?php /* Smarty version Smarty-3.1.21-dev, created on 2026-04-22 18:14:43
         compiled from "/www/wwwroot/zzzz.com/uploads/app/template/wap/member/user/resume.htm" */ ?>
<?php /*%%SmartyHeaderCode:180762961569e89f93e87b97-85000969%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7893cd887a90429761b0e2ea2add792f65f113d1' => 
    array (
      0 => '/www/wwwroot/zzzz.com/uploads/app/template/wap/member/user/resume.htm',
      1 => 1706496290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180762961569e89f93e87b97-85000969',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69e89f93eaa2e5_93309848',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69e89f93eaa2e5_93309848')) {function content_69e89f93eaa2e5_93309848($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/wwwroot/zzzz.com/uploads/app/include/libs/plugins/function.url.php';
...
/images/conceal_1.png" alt="" width="100%" height="100%">
			...
			<div class="hint_right_del" onclick="closePrivacy()">
				<img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/remove.png" alt="" width="100%" height="100%">
			</div>
		</div>
					...
					<div class="resume_min_body_cord_data_left" onclick="navigateTo('index.php?c=info')">
						<div class="data_left_nameandmodification">
							...
							<div class="data_left_modification">
								<img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/icon_question.png" alt="" width="100%" height="100%">
							</div>
						</div>
				...
				<div class="resume_min_body_cord_intention">
					...
					<div class="cord_intention_bom" @click="pageTo('index.php?c=addexpect&eid='+expect.id)">
						...
						<div class="cord_intention_bom_icon">
							<img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/icon_more.png" alt="" width="100%" height="100%">
						</div>
					</div>
				</div>
				<!-- 工作经历 -->
					...
					<div class="resume_top_box">
						<div class="resume_top_box_left">
							<div class="top_box_icon_new">
								<img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/resume_top.png" alt="" width="100%">
							</div>
					...
					<div class="resume_refresh_box resume_top_box">
						<div class="resume_top_box_left">
							<div class="top_box_icon_new">
								<img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/resume_refresh.png" alt=""  width="100%">
							</div>
							<div class="top_box_text">
...
/images/dredge_zfb.png" alt="" width="100%" height="100%"></div>
...
';
			var privacy = '<?php echo $_COOKIE['privacy'];?>
';
...
',
		        ...
		        methods: {
					resumeList: function(){
						...
						var self = this;
						self.elist = [];
						$.post('<?php echo smarty_function_url(array('d'=>'wxapp','h'=>'user','m'=>'resume','c'=>'resume'),$_smarty_tpl);?>
', {eid: this.eid}, function(data){
							hideLoading();
							var list = data.data;
...
',formData,function(data){
				    ...
				    delResume:function(){
						...
						showLoading('删除中...');
						$.post("<?php echo smarty_function_url(array('d'=>'wxapp','h'=>'user','m'=>'resume','c'=>'del_resume'),$_smarty_tpl);?>
", param, function(data) {
							hideLoading();
							if (data.error == 1) {
				    ...
				    defaults:function(){
						...
						showLoading('设置中...');
						$.post("<?php echo smarty_function_url(array('d'=>'wxapp','h'=>'user','m'=>'resume','c'=>'default_resume'),$_smarty_tpl);?>
", param, function(data) {
							hideLoading();
							if (data.error == 1) {
