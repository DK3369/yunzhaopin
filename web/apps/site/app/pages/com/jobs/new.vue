  ...
  <MemberPanel :title="$t('wap_00322')">
    <form class="com_release_box" @submit.prevent="submit">
      ...
      <template v-if="form.salary_type !== 1">
        <MemberReleaseRow :label="$t('ui.min_salary')"><input v-model.number="form.minsalary" type="number" /></MemberReleaseRow>
        <MemberReleaseRow :label="$t('ui.max_salary')"><input v-model.number="form.maxsalary" type="number" /></MemberReleaseRow>
      </template>
      ...
      <MemberReleaseRow :label="$t('ui.job_desc')" area><textarea v-model="form.content" rows="8" /></MemberReleaseRow>
      ...
      <MemberReleaseRow :label="$t('member_com_00528')">
        <label>
