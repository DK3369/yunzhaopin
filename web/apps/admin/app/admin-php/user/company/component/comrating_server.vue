<template>
    ...
    <div class="moduleElHight">
        <div class="tableSeachInpt">
            <el-button type="primary" icon="el-icon-plus" size="small" @click="handleAdd">{{ lc('admin_user_company_00207') }}</el-button>
            <el-button type="primary" icon="el-icon-plus" plain size="small" @click="handleDetailAdd">{{ lc('admin_00697') }}</el-button>
        </div>
                ...
                <el-table-column :label="lc('member_user_00048')" width="210" fixed="right">
                    <template #default="scope">
                        <div class="cz_button">
                            ...
                            <el-button size="small" plain @click="handleDetail(scope)">{{ lc('member_com_00380') }}</el-button>
        ...
        <div class="modluDrawer">
            <el-dialog :title="titleAddEdit" v-model="addVisible" :with-header="true" :modal-append-to-body="false"
        ...
        <div class="modluDrawer">
            <el-drawer :title="titleDetail" v-model="detailVisible" :append-to-body="true" :modal-append-to-body="false"
                :show-close="true" :destroy-on-close="true" size="95%">
                <comrating_server_detail :id="info?info.id:0"></comrating_server_detail>
            </el-drawer>
        </div>
        <div class="modluDrawer">
            <el-drawer :title="lc('admin_00697')" v-model="detailAddVisible" :append-to-body="true" :modal-append-to-body="false" :wrapper-closable="false" :destroy-on-close="true" size="770px">
...
<script>
import ComratingServerDetail from './comrating_server_detail.vue'
...
export default {
    ...
    components: {
        'comrating_server_detail': ComratingServerDetail,
