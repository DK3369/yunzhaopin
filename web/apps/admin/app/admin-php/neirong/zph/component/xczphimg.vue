    ...
    <div class="moduleElHight" style="padding: 0 20px;">
        ...
        <div class="modulemoreSeach" style="width: 100%;">
            ...
            <div class="moduleHeadrButn" style="margin-bottom: 12px;margin-left: 10px;">
                <el-button type="primary" icon="el-icon-document-add" size="small" @click="addPic">{{ lc('admin_00586') }}</el-button>
            </div>
        </div>
                ...
                <el-table-column fixed="right" :label="lc('member_user_00048')" width="250">
                    <template #default="scope">
                        <div class="moduleElTaCaoz">
                            <el-button size="small" @click="editPic(scope.row)">{{ lc('wap_js_00073') }}</el-button>
                            <el-button type="danger" size="small" @click="delrow(scope.row.id)">{{ lc('common.delete') }}</el-button>
                            <el-button v-if="scope.row.is_themb == '0'" size="small"
        ...
        <div class="modluDrawer">
            <el-drawer :title="info.id ? lc('admin_vue_00122') : lc('admin_00586')" v-model="editBox" append-to-body
        ...
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_00308')" v-model="delTplBox" :with-header="true" :modal-append-to-body="false"
