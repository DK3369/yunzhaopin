...
impl Db {
    ...
    pub async fn connect(cfg: &Config) -> anyhow::Result<Self> {
        ...
        tracing::info!(
            ...
            slow_query_ms = crate::numeric::saturating_millis(SLOW_QUERY_THRESHOLD),
    ...
    pub async fn healthy(&self) -> bool {
        ...
        let cached_ts = i64::try_from(packed & 0xFFFF_FFFF).unwrap_or_default();
        ...
        let now_low = u64::try_from(now.rem_euclid(1_i64 << 32)).unwrap_or_default();
        let new_packed = (status << 32) | now_low;
