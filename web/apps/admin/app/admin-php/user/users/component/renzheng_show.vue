    ...
    <div class="moduleElHight">
        ...
        <div class="moduleElTable" :class="{ 'modulElTableGai': tableHig }" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe
                ...
                <el-table-column prop="name" :label="lc('wap_00529')">
                </el-table-column>
                <el-table-column prop="username" :label="lc('admin_user_00140')">
                </el-table-column>
                <el-table-column prop="wenjian" :label="lc('admin_user_00190')">
        ...
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_00465')" v-model="statusVisible" :with-header="true" :modal-append-to-body="false"
                ...
                <div>
                    ...
                    <div class="wxsettip_small ">{{ lc('admin_user_00189') }}</div>
                    <div class="zzrz_img">
        ...
        <!-- Edit dialog -->
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_00466')" v-model="editVisible" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
                <div class="wxsettip_small ">{{ lc('wap_00529') }}</div>
                <el-input placeholder="" v-model="info.name" :disabled="true"></el-input>
                <div class="wxsettip_small ">{{ lc('admin_00464') }}</div>
