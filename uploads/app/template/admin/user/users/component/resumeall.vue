    ...
    <div class="moduleElHight">
        <div class="moduleSeachbig">
            <div class="tableSeachInpt tableSeachInptsmall">
                <el-input :placeholder="lc('admin_user_00158')" @keyup.enter.native="search" size="small" v-model="searchForm.keyword"
                          clearable>
					<el-select v-model="searchForm.keytype" style="padding-left: 12px;" size="small" slot="prepend" :placeholder="lc('wap_user_00015')">
            ...
            <div class="tableSeachInpt">
                <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="openAdd">{{ lc('admin_user_00193') }}</el-button>
        ...
        <div class="moduleElTable" :class="{ 'moduleElTabGetResuma': tableHig }"
            ...
            <el-table :data="list" style="width: 100%" stripe ref="multipleTable" @selection-change="handleSelectionChange"
                ...
                <el-table-column :label="lc('member_user_00048')" width="140" fixed="right">
                    <template slot-scope="scope">
                        <div class="cz_button">
                            <el-button size="mini" plain @click="openAudit(scope.row)">{{ lc('member_user_00152') }}</el-button>

                            <el-button size="mini" plain @click="refresh(scope.row)">{{ lc('wap_user_00334') }}</el-button>
                        </div>
                        <div class="cz_button" style="margin-top: 10px;">
                            <el-button size="mini" plain @click="openRemark(scope.row)">{{ lc('member_user_00242') }}</el-button>

                            <el-button type="danger" size="mini" @click="openDel(scope.$index)">{{ lc('common.delete') }}</el-button>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <div class="modulePaging" style="height: initial; flex-wrap: wrap; padding-top: 10px;">
            <div class="bottomButnBull" style="width:100%;">
                <div class="bottomButnBlak">
                    ...
                    <el-button size="mini" @click="batch('del')">{{ lc('member_com_00055') }}</el-button>
                    <el-button size="mini" @click="batch('audit')">{{ lc('admin_user_weipin_00037') }}</el-button>
                    <el-button size="mini" @click="batch('refresh')">{{ lc('admin_user_00248') }}</el-button>
                    <el-button size="mini" @click="batch('rec')">{{ lc('admin_user_00237') }}</el-button>
                    <el-button size="mini" @click="batch('rec_cancel')">{{ lc('wap_com_00230') }}</el-button>
                    <el-button size="mini" @click="batch('top')">{{ lc('admin_00500') }}</el-button>
                    <el-button size="mini" @click="batch('top_cancel')">{{ lc('wap_com_00231') }}</el-button>
                    <el-button size="mini" @click="batch('export')">{{ lc('admin_user_00257') }}</el-button>
                </div>
            </div>
        ...
        <div class="modluDrawer">
            <!-- 导出字段选择弹出 -->
            <el-dialog :title="lc('admin_user_00246')" :visible.sync="dialogExport" :with-header="true" :modal-append-to-body="false"
        ...
        <!--公开简历-->
        <div class="modluDrawer">
            <el-dialog :title="lc('member_com_00110')" :visible.sync="dialogStatus" :with-header="true" :modal-append-to-body="false"
        ...
        <!--简历置顶-->
        <div class="modluDrawer">
            <el-dialog :title="lc('wap_user_00207')" :visible.sync="dialogTop" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
        ...
        <!--简历备注-->
        <div class=" ">
            <el-dialog :title="lc('wap_com_00070')" :visible.sync="dialogRemark" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
        ...
        <!--投递记录-->
        <el-drawer :title="lc('admin_00517')" :append-to-body="true" :visible.sync="drawerJobSqLog" size="80%">
        ...
        <!--批量审核-->
        <el-dialog :title="lc('admin_user_weipin_00037')" :visible.sync="dialogAudit" :modal-append-to-body="false" :show-close="true" width="500px">
        ...
        <!--简历审核-->
        <el-drawer :title="lc('member_com_00028')" :visible.sync="drawerAudit" @closed="closedAudit"
        ...
        <!--删除弹窗-->
        <div class="modluDrawer">
            <el-dialog :title="lc('admin_user_00241')" :visible.sync="dialogDel" :with-header="true" append-to-body :show-close="true"
                width="300px">
                <div>
        ...
        <div class="modluDrawer">
            ...
            <!--新增简历-->
            <el-drawer :title="lc('admin_user_00193')" :visible.sync="drawerAdd" append-to-body :wrapper-closable="false" size="45%">
