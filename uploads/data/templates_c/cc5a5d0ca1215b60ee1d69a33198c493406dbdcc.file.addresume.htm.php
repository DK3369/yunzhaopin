<?php /* Smarty version Smarty-3.1.21-dev, created on 2026-04-22 17:35:40
         compiled from "/www/wwwroot/zzzz.com/uploads/app/template/wap/member/user/addresume.htm" */ ?>
<?php /*%%SmartyHeaderCode:160647616169e8966c351a31-03661800%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc5a5d0ca1215b60ee1d69a33198c493406dbdcc' => 
    array (
      0 => '/www/wwwroot/zzzz.com/uploads/app/template/wap/member/user/addresume.htm',
      1 => 1700725935,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '160647616169e8966c351a31-03661800',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69e8966c36c3f7_14863708',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69e8966c36c3f7_14863708')) {function content_69e8966c36c3f7_14863708($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/wwwroot/zzzz.com/uploads/app/include/libs/plugins/function.url.php';
...
/images/nav_icon_return.png" alt="" width="100%" height="100%">
    ...
    <div class="create_resume_p">完善信息，精准高薪职位推荐</div>
    <div class="create_resume_img">
        <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/resume_title.png" alt="" width="100%" height="100%">
    </div>
</div>
        ...
        <form id="firstSubmit">
            <div class="yun_createbox ">
                <div class="yun_createlist yun_createlist_pr">
                    ...
                    <div class="yun_create_text"><input type="text" name="realname" v-model="info.name" placeholder="请输入姓名"></div>
                    <div class="yun_create_gender">
                        <div :class="info.sex == 1 ? 'yun_create_genderselect' : ''" @click="changeSex(1)">男</div>
                        <div :class="info.sex == 2 ? 'yun_create_genderselect' : ''" @click="changeSex(2)">女</div>
                        <input type="hidden" name="sex" :value="info.sex"/>
                    </div>
                </div>

                <div class="yun_createlist" @click="classBox('job')">
                    <div class="yun_create_name"><span class="m_bt">*</span>工作职能</div>
                    <div class="yun_create_select" id="jobnameshow" style="color:#cecccc;">{{jobname}}</div>
                    <div class="yun_create_fx"><img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%"></div>
                    <input type="hidden" id="job_classid" name="jobclassid" :value="jobclassid"/>
                </div>

                <div class="yun_createlist">
                    <div class="yun_create_name"><span class="m_bt">*</span>求职意向</div>
                    <div class="yun_create_select" @click="expectBox = true" v-if="expectCon">{{expectCon}}</div>
                    <div class="yun_create_select" @click="expectBox = true" style="color:#cecccc;" v-else>{{noexpectCon}}</div>
                    <div class="yun_create_fx"><img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%"></div>
                </div>
                <div class="yun_createlist">
                    <div class="yun_create_name"><span class="m_bt">*</span>现居住地</div>
                    <div class="yun_create_text"><input type="text" name="living" v-model="info.living" placeholder="请输入现居住地"/></div>
                </div>
                <div class="yun_createlist" @click="typeShow = true">
                    <div class="yun_create_name"><span class="m_bt">*</span>工作性质</div>
                    <div class="yun_create_select" v-if="info.type_n">{{info.type_n}}</div>
                    <div class="yun_create_select" style="color:#cecccc;" v-else>请选择工作性质</div>
                    <div class="yun_create_fx">
                        <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%">
                    </div>
                    <input type="hidden" id="type" name="type" :value="info.type">
                </div>
                <div class="yun_createlist">
                    <div class="yun_create_name"><span class="m_bt">*</span>手机号码</div>
                    <div class="yun_create_text" v-if="info.moblie_status==1&&info.telphone">
                        <div class="yun_create_bkt">{{info.telphone}}</div>
                        <i class="yun_create_tip">已验证</i>
                        <input type="hidden" name="telphone" v-model="info.telphone">
                    </div>
                    <div class="yun_create_text" v-else>
                        <input oninput="value=value.replace(/^0|[\^d]/g,'')" type="number" name="telphone" v-model="info.telphone" placeholder="请输入手机号"/>
                    </div>
                </div>
                <div class="create_resume_yx">
                    <div class="yun_more_xz ">
                        <div class="yun_more_xz_left yun_more_yxline" onclick="birthdayPicker()">
                            <div class="yun_more_xzname"><span class="m_bt">*</span>出生年月</div>
                            <div class="yun_more_xz_p" v-if="info.birthYear">{{info.birthYear}}</div>
                            <div class="yun_more_xz_p" style="color:#cecccc;" v-else>请选择</div>
                            <input type="hidden" name="birthday" :value="info.birthday"/>
                        </div>
                        <div class="yun_more_xz_cen yun_more_yxline" @click="eduPicker">
                            <div class="yun_more_xzname"><span class="m_bt">*</span>最高学历</div>
                            <div class="yun_more_xz_p" v-if="info.edu_n">{{info.edu_n}}</div>
                            <div class="yun_more_xz_p" style="color:#cecccc;" v-else>请选择</div>
                            <input type="hidden" id="edu" name="edu" :value="info.edu"/>
                        </div>
                        <div class="yun_more_xz_right" @click="expPicker">
                            <div class="yun_more_xzname"><span class="m_bt">*</span>工作经验</div>
                            <div class="yun_more_xz_p" v-if="info.exp_n">{{info.exp_n}}</div>
                            <div class="yun_more_xz_p" style="color:#cecccc;" v-else>请选择</div>
    ...
    <!--求职意向-->
    <van-popup v-model="expectBox" @opened="changeName" position="right" :style="{ height: '100%',width:'100%',backgroundColor:'#f3f3f3'}">
        <!-- 页面头部 -->
                ...
                <form id="expectSubmit">
                    <div class="yun_createlist">
                        ...
                        <div class="yun_create_text">
                            <input type="text" name="name" id="name" value="" placeholder="请输入期望职位名称"/>
                        </div>
                    </div>
                    <div class="yun_createlist" @click="salaryBox = true">
                        ...
                        <div class="yun_create_select" style="color:#cecccc;" v-else>{{nosalary}}</div>
                        <div class="yun_create_fx"><img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%"></div>
                    ...
                    <div class="yun_createlist" @click="classBox('city')">
                        ...
                        <div class="yun_create_select" id="citynameshow" style="color:#cecccc;">{{cityname}}</div>
                        <div class="yun_create_fx"><img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%"></div>
                        <input type="hidden" id="city_classid" name="cityclassid" :value="cityclassid"/>
                    </div>
                    <div class="yun_createlist" @click="rjShow = true">
                        <div class="yun_create_name"><span class="m_bt">&nbsp;</span>求职状态</div>
                        <div class="yun_create_select">{{rjValue}}</div>
                        <div class="yun_create_fx"><img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%"></div>
                        <input type="hidden" name="jobstatus" :value="info.jobstatus"/>
                        <input type="hidden" name="report" :value="info.report"/>
                    </div>
                    <div class="yun_createlist create_resume_listend Modify_bottom_margin" @click="hyShow = true">
                        <div class="yun_create_name"><span class="m_bt">&nbsp;</span>从事行业</div>
                        <div class="yun_create_select" v-if="info.hy_n">{{info.hy_n}}</div>
...
/images/yunfx.png" alt="" width="100%" height="100%"></div>
    ...
    <van-popup v-model="typeShow" round position="bottom">
        <van-picker show-toolbar :columns="type" :default-index="typeIndex" @cancel="typeShow = false" @confirm="typeConfirm"/>
    </van-popup>

    <van-popup v-model="birthdayShow" round position="bottom">
        <van-datetime-picker v-model="currentYear" type="year-month" :min-date="minYear" :max-date="maxYear" @cancel="birthdayShow = false" @confirm="birthdayConfirm"/>
    </van-popup>
    ...
    <van-popup v-model="hyShow" round position="bottom">
        <van-picker show-toolbar :columns="hy" :default-index="hyIndex" @cancel="hyShow = false" @confirm="hyConfirm"/>
    </van-popup>
    ...
    <!--                <input type="number" oninput="value=value.replace(/^0|[\^d]/g,'')" name="minsalary" :value="minsalary" placeholder="请输入最低薪资"/>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--        <div class="salary_list">-->
    <!--            <div class="salaryname">最高薪资：</div>-->
    <!--            <div class="salary_text">-->
    <!--                <input type="number" oninput="value=value.replace(/^0|[\^d]/g,'')" name="maxsalary" :value="maxsalary" placeholder="请输入最高薪资"/>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--        <div class="salary_subnew">-->
    <!--            <div class="compensation_input_btn" @click="salarySubmit">确认</div>-->
    <!--        </div>-->
    <!--    </form>-->
    <!--</van-popup>-->
...
/images/nav_icon_return.png" alt="" width="100%" height="100%">
        ...
        <div class="description_box">
            <div class="resume_ms_textarea">
                <textarea v-model="content" placeholder="请输入描述" style="width: 100%;height: 300px;border: none;outline: none;"></textarea>
            </div>
...
/images/nav_icon_return.png" alt="" width="100%" height="100%">
        ...
        <div id="workBox" class="personal_details_min_body">
            <form id="workSubmit">
                <div class="yun_createbox yun_tj_box" v-for="(item, wk) in workList" :key="wk">
                    <div class="yun_createlist">
                        <div class="yun_create_name"><span class="m_bt">*</span>公司名称</div>
                        <div class="yun_create_text yun_jl_text">
                            <input type="text" :name="'workname_' + wk" value="" placeholder="请输入单位名称">
                        </div>
                        <div v-if="1 > wk > 0 " class="yun_tjicon" @click="addNewHtml('work')">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/addition.png" alt="" width="100%" height="100%">
                        </div>
                        <div v-if="wk > 0" @click="delNewHtml('work', wk)" class="yun_tjicon">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/delete.png" alt="" width="100%" height="100%">
                        </div>
                    </div>
                    <div class="yun_createlist">
                    ...
                    <div class="yun_createlist">
                        ...
                        <div class="yun_create_select job_resume_right_two" @click="showContent('workList', wk)"
                             v-if="item.content">{{item.content}}
                        </div>
                        <div class="yun_create_select job_resume_right_two" @click="showContent('workList', wk)"
                             style="color:#cecccc;" v-else>请填写工作内容
                        </div>
                        <div class="yun_create_fx">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%">
                    ...
                    <div class="yun_time_box">
                        <div class="yun_time_all">
                            <div class="yun_b_xzp" @click="timeShow('workList',wk, 'sdate')">
                                <div class="yun_time_name"><span class="m_bt">*</span>入职时间</div>
                                <div class="yun_b_xz" v-if="item.sdate">{{item.sdate}}</div>
                                <div class="yun_b_xz" style="color:#cecccc;" v-else>请选择</div>
                                <input type="hidden" :name="'worksdate_' + wk" :value="item.sdate">
                            </div>
                            <div class="yun_b_z">至</div>
                            <div class="yun_b_xzp" @click="timeShow('workList', wk, 'edate')">
                                <div class="yun_time_name"><span class="m_bt">*</span>离职时间</span></div>
                                <div class="yun_b_xz" v-if="item.edate">{{item.edate}}</div>
                                <div class="yun_b_xz" style="color:#cecccc;" v-else>请选择</div>
                ...
                <div class="tg_bth" @click="skipPage('work')" v-if="info.iscreateexpshow"><span>跳过</span></div>
            </form>
        </div>
    </van-popup>
...
/images/nav_icon_return.png" alt="" width="100%" height="100%">
        ...
        <div id="eduBox" class="personal_details_min_body">
            <form id="eduSubmit">
                <div class="yun_createbox yun_tj_box" v-for="(item, ek) in eduList" :key="ek">
                    <div class="yun_createlist">
                        <div class="yun_create_name"><span class="m_bt">*</span>学校名称</div>
                        <div class="yun_create_text yun_jl_text">
                            <input type="text" :name="'eduname_' + ek" value="" placeholder="请输入学校名称">
                        </div>
                        <div v-if="1 > ek > 0 " class="yun_tjicon" @click="addNewHtml('edu')">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/addition.png" alt="" width="100%" height="100%">
                        </div>
                        <div v-if="ek > 0" @click="delNewHtml('edu', ek)" class="yun_tjicon">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/delete.png" alt="" width="100%" height="100%">
                        </div>
                    </div>
                    ...
                    <div class="yun_createlist" @click="eduPicker(ek)">
                        <div class="yun_create_name"><span class="m_bt">&nbsp;</span>最高学历</div>
                        <div class="yun_create_select" v-if="item.edu">{{item.edu}}</div>
                        <div class="yun_create_select" style="color:#cecccc;" v-else>请选择学历</div>
                        <div class="yun_create_fx">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%">
                        </div>
                    ...
                    <div class="yun_time_box">
                        <div class="yun_time_all">
                            <div class="yun_b_xzp" @click="timeShow('eduList',ek, 'sdate')">
                            ...
                            <div class="yun_b_z">至</div>
                            <div class="yun_b_xzp" @click="timeShow('eduList',ek, 'edate')">
                                <div class="yun_time_name"><span class="m_bt">*</span>离校时间</div>
                                <div class="yun_b_xz" v-if="item.edate">{{item.edate}}</div>
                                <div class="yun_b_xz" style="color:#cecccc;" v-else>请选择</div>
                ...
                <div class="tg_bth" @click="skipPage('edu')" v-if="info.iscreateedushow"><span>跳过</span></div>
            </form>
        </div>
    </van-popup>
...
/images/nav_icon_return.png" alt="" width="100%" height="100%">
        ...
        <div id="projectBox" class="personal_details_min_body">
            <form id="projectSubmit">
                <div class="yun_createbox yun_tj_box" v-for="(item, pk) in projectList" :key="pk">
                    <div class="yun_createlist">
                        <div class="yun_create_name"><span class="m_bt">*</span>项目名称</div>
                        <div class="yun_create_text yun_jl_text">
                            <input type="text" :name="'projectname_' + pk" value="" placeholder="请输入项目名称">
                        </div>
                        <div v-if="1 > pk > 0 " class="yun_tjicon" @click="addNewHtml('project')">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/addition.png" alt="" width="100%" height="100%">
                        </div>
                        <div v-if="pk > 0" @click="delNewHtml('project', pk)" class="yun_tjicon">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/delete.png" alt="" width="100%" height="100%">
                        </div>
                    </div>
                    ...
                    <div class="yun_createlist">
                        <div class="yun_create_name"><span class="m_bt">&nbsp;</span>项目内容</div>
                        <div class="yun_create_select" @click="showContent('projectList', pk)" v-if="item.content">{{item.content}}</div>
                        <div class="yun_create_select" @click="showContent('projectList', pk)" style="color:#cecccc;" v-else>请填写项目内容</div>
                        <div class="yun_create_fx">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/images/yunfx.png" alt="" width="100%" height="100%">
                        </div>
                    ...
                    <div class="yun_time_box">
                        <div class="yun_time_all">
                            <div class="yun_b_xzp" @click="timeShow('projectList',pk, 'sdate')">
                            ...
                            <div class="yun_b_z">至</div>
                            <div class="yun_b_xzp" @click="timeShow('projectList',pk, 'edate')">
                ...
                <div class="tg_bth" @click="skipPage('pro')" v-if="info.iscreateproshow"><span>跳过</span></div>
            </form>
        </div>
    </van-popup>
</div>
    ...
    var yunvue = new Vue({
        ...
        data() {
            return {
                ...
                birthdayShow: false,
                currentYear: 0,
                minYear: new Date(1960, 0),
                maxYear: new Date(year-16,11),
                rjShow: false,
                rj: [],
                rjValue: '请选择求职状态',
                salary: '',
        ...
        methods: {
            infoShow: function () {
                let self = this;
                showLoading();
                $.post('<?php echo smarty_function_url(array('d'=>'wxapp','h'=>'user','m'=>'resume','c'=>'addresume'),$_smarty_tpl);?>
', {rand: Math.random()}, function (res) {
                    ...
                    if (res.error == 0) {
                        ...
                        if (res.data.salaryList.length > 0) {
                            self.salaryList = res.data.salaryList;
                            let minsalaryColumns = {values: [], defaultIndex: 0};
                            maxsalaryColumns = {values: [], defaultIndex: 0};

                            self.salaryList.forEach(function(item,index) {
                                if (index < self.salaryList.length - 1) {
                            ...
                            self.salaryColumns = [minsalaryColumns, maxsalaryColumns];
                        }
                    } else {
                    ...
                    cmcCss.href = "<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
...
";
            ...
            birthdayConfirm(e) {
                ...
                this.info.birthday = timeFormat(e, 'month');
            },
            ...
            classBox: function (type) {
                ...
                cmcJs.src = "<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
...
";
            ...
            changeName() {
                let jobnameshow = $("#jobnameshow").text();
                let name = $("#name").val();

                if (name == '' && jobnameshow != '请选择工作职能') {
                    var jobname_arr = this.jobname.split(' ');
                    $("#name").val(jobname_arr[0]);
                }
            },
            ...
            firstSubmit: function () {
                ...
                if (!evalue.realname) {
                    ...
                    var resumename = '<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_resumename_num'];?>
';
                ...
                if (this.info.resume_create_edu != 1 && this.info.resume_create_exp != 1 && this.info.resume_create_project != 1) {
                    ...
                    $.post('<?php echo smarty_function_url(array('d'=>'wxapp','h'=>'user','m'=>'resume','c'=>'saveaddresume'),$_smarty_tpl);?>
', formData, function (data) {
                        hideLoading();
                        if (data.error == 1) {

                            that.eid = data.data.eid;

                            /* 新增必填项判断Start */
                            var jobClassArr = evalue.jobclassid.split(',');
                            ji.forEach(one => {
                                jobClassArr.forEach(j1 => {
                                    if (j1 == one) {
                                ...
                                if (typeof (jt[one]) != 'undefined') {
                                    jt[one].forEach(two => {
                                        jobClassArr.forEach(j2 => {
                                            if (j2 == two) {
                                                if (that.info.jobClassCreate.indexOf(two) > -1) {
                                                    that.isShow = true;
                                                }
                                            }
                                        });
                                        if (typeof (jt[two]) != 'undefined') {
                                            jt[two].forEach(three => {
                                                jobClassArr.forEach(j3 => {
                                                    if (j3 == three) {
                                                        if (that.info.jobClassCreate.indexOf(three) > -1) {
                                                            that.isShow = true;
                                                        }
                                                    }
                                                });
                            ...
                            if (that.info.resume_create_exp == 1) {
                                // 工作经历必填
                                if (that.info.expcreate.includes(formData.exp) || that.isShow) {
                                    // 工作经历可以跳过
                                ...
                                // 教育经历必填
                                if (that.info.educreate.includes(formData.edu) || that.isShow) {
                                    // 教育经历可以跳过
                                ...
                                if (that.info.expcreate.includes(formData.exp) || that.isShow) {
                                    // 工作经历可以跳过
                                    that.info.iscreateproshow = true;
                                } else {
                                    that.info.iscreateproshow = false;
                                }
...
', formData, function (data) {
            ...
            loadJs: function () {
                ...
                a.src = "<?php echo $_smarty_tpl->tpl_vars['plusstyle']->value;?>
/user.cache.js?v=<?php echo $_smarty_tpl->tpl_vars['config']->value['cachecode'];?>
";
                document.body.appendChild(a);

                let g = document.createElement('script');
                g.src = "<?php echo $_smarty_tpl->tpl_vars['plusstyle']->value;?>
/industry.cache.js?v=<?php echo $_smarty_tpl->tpl_vars['config']->value['cachecode'];?>
";
                document.body.appendChild(g);

                // js加载完成，处理默认值
                $.getScript('<?php echo $_smarty_tpl->tpl_vars['wap_style']->value;?>
/js/userPicker.js?v=<?php echo $_smarty_tpl->tpl_vars['config']->value['cachecode'];?>
', function () {
                    setTimeout(function () {
                        typePicker(0, false);
                        rjPicker(0, 0, false);
...
<!--职能、城市公共弹窗-->
<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['wapstyle']->value)."/member/public/resume_city_job.htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
