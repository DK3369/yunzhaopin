<template>
    <div v-loading="loading">
        ...
        <div class="modluDrawer">
            <el-drawer v-model="cityVisible" :with-header="false" :modal-append-to-body="false" append-to-body
                ...
                <div class="modluDrawerContents">
                                ...
                                <div class="xuanzlTwo">
                                    <div v-for="(twoItem, twoIndex) in oneItem.children" :key="twoIndex" class="xuanzlTwoList">
                                        ...
                                        <el-popover v-if="twoItem.children" placement="bottom" width="350" trigger="click">
                                            ...
                                            <template #reference><div class="xuanzNamte" :data-id="twoItem.id"
                    ...
                    <div class="dialog-footer dialoFoofetee">
                        ...
                        <div class="footTextburn">
                            <el-button type="primary" size="small" round @click="handleSubmitCity">{{ lc('wap_com_00019') }}</el-button>
                        </div>
                    </div>
                </div>
            </el-drawer>
