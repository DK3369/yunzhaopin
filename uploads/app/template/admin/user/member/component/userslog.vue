    ...
    <div class="moduleElHight">
        <div class="moduleSeachbig">
            ...
            <div class="tableSeachInpt">
                <el-input placeholder="{yun:}t key='wap_user_00076'{/yun}" @keyup.enter.native="doUserQuery" size="small" prefix-icon="el-icon-search" v-model="search.content" clearable>
                </el-input>
            </div>
        ...
        <div class="moduleElTable moduleElTabUselod"
            ...
            <el-table :data="tableData" style="width: 100%" stripe @selection-change="selectChange" ref="multipleTable"
                ...
                <el-table-column prop="zzh" label="{yun:}t key='wap_00529'{/yun}"  width="100" show-overflow-tooltip>
                ...
                <el-table-column prop="ctime_ymd" label="{yun:}t key='wap_js_00088'{/yun}" width="170" sortable="custom"></el-table-column>
        ...
        <div class="modluDrawer">
            <el-drawer title="{yun:}t key='member_user_00037'{/yun}" :append-to-body="true" :visible.sync="resumePreviewVisible" :destroy-on-close="true"
                size="530px">
    ...
    data: function () {
        return {
            ...
            operasArr: {
                ...
                2: "{yun:}t key='common.resume'{/yun}",
                6: "{yun:}t key='wap_00574'{/yun}",
                ...
                26: "{yun:}t key='wap_user_00221'{/yun}"
            },
            items: [
